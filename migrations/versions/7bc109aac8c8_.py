...
Revision ID: 7bc109aac8c8
Revises: 
Create Date: 2023-01-07 12:50:54.955365
...
def upgrade():
    ...
    op.create_table('admin_handicap',
    sa.Column('id', sa.Integer(), nullable=False, comment='盘口ID'),
    sa.Column('name', sa.String(length=255), nullable=True, comment='盘口名称'),
    ...
    sa.Column('schema_url', sa.String(length=255), nullable=True, comment='初始化路径'),
    ...
    sa.Column('username', sa.String(length=255), nullable=True, comment='会员账户'),
    sa.Column('realname', sa.String(length=255), nullable=True, comment='真实姓名'),
    sa.Column('bank', sa.String(length=255), nullable=True, comment='绑定银行卡'),
    sa.Column('tag', sa.String(length=255), nullable=True, comment='彩金标签'),
    sa.Column('iphone', sa.String(length=20), nullable=True, comment='联系电话'),
    sa.Column('details', sa.String(length=255), nullable=True, comment='备注'),
    sa.Column('is_del', sa.Integer(), nullable=True, comment='是否已删除'),
