import os, platform, re, time, psutil, json
from datetime import datetime
from flask import Blueprint
from applications.common.utils.rights import authenticate
from applications.common.utils.http import Success
from applications.common.utils.jsoncoder import DateEncoder


admin_monitor = Blueprint('adminMonitor', __name__)


# 系统监控
@admin_monitor.get('/monitor')
# @authenticate("admin:monitor:main", log=True)
def main():
    # 主机名称
    ...
    return Success(data=json.loads(json.dumps(data, cls=DateEncoder)))
